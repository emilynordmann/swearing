...
### One-way ANOVA, general fluency by gender

```{r, echo = FALSE, message=FALSE}
anova_dat_animal <- all_counts %>%
  filter(type == "animal",
         gender != "Other") %>%
  droplevels()
...
### One-way ANOVA, swearing by gender
...
wordcloud(words = swears$words, max.words = 90)
```
...
wordcloud(words = swears_man$words, max.words = 90)
...
```{r, echo = FALSE, fig.align="center", warning = FALSE, message = FALSE}
wordcloud(words = swears_woman$words, max.words = 90)
```

## Word cloud - non-binary/other

```{r, echo = FALSE, fig.align="center", warning = FALSE, message = FALSE}
wordcloud(words = swears_other$words, max.words = 90)
```
